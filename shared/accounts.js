...
let playerDB = new sqlite.Database(
  "playerdata.db",
...
class PlayerAccount {
  ...
  constructor(
    id,
    currentAuthToken,
    currentAuthTokenExpirationTime,
    currentServerId,
...
module.exports = {
  ...
  AsyncUpdateCurrentPlayerAuthToken:
    async function AsyncUpdateCurrentPlayerAuthToken(id, token) {
      await asyncDBRun(
  ...
  AsyncUpdatePlayerCurrentServer: async function AsyncUpdatePlayerCurrentServer(
    id,
    serverId
  ) {
  ...
  AsyncWritePlayerPersistenceBaseline:
    async function AsyncWritePlayerPersistenceBaseline(
      id,
      persistentDataBaseline
    ) {
      await asyncDBRun(
  ...
  AsyncGetPlayerModPersistence: async function AsyncGetPlayerModPersistence(
    id,
    pdiffHash
  ) {
    return JSON.parse(
  ...
  AsyncWritePlayerModPersistence: async function AsyncWritePlayerModPersistence(
    id,
    pdiffHash,
    data
  ) {},
